...
The program will enter a new line character to indicate when the sort is indicated, and that it is ready for input. This
only took 1-3 seconds on the ugrad system, so PLEASE wait for this new line before typing input. Thanks!
